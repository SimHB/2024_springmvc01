...
<html>
	...
	<body>
		...
		<form action="/start8" method="get" autocomplete="on">
			<p><label> 이름 : <input type="text" name="username" placeholder="이름 입력" required> </label></p>
			<p><label> 나이 : <input type="number" name="userage" placeholder="나이 입력" required> </label></p>
		...
		<h3><a href="/member_list">Members 전체보기</a></h3>
		<hr>
		<!-- 이미지는 무조건 webapp-resources 안에 넣어주세요 -->
		<h2>이미지 보기</h2>
		<img alt="" src="/resources/images/cat.jpg" style="width: 100px;"><br>
		<img alt="" src="resources/images/cat.jpg" style="width: 100px;"><br>
		
		<!-- 추천 : 어플리케이션 컨텍스트 경로가 변경되어도 이미지 경로가 올바르게 참조 -->
		<img alt="" src='<c:url value="/resources/images/cat.jpg" />' style="width: 100px;"><br>
		<img alt="" src="<c:url value='resources/images/cat.jpg' />" style="width: 100px;"><br>
		<hr>
		...
		<!--
			...
			파일업로드용 클래스 등록 사용하면 COS 라이브러리를 활용한 업/다운로드 불가능
		-->
		<h2>파일 업로드-2</h2>
		...
		<h2><a href="/emp">동적쿼리 연습하는 장소로 이동</a></h2>
