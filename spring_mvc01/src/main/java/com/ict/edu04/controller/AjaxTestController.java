...
public class AjaxTestController {
	...
	@ResponseBody
	// 반환형이 String 인 경우 문서 타입이 contextType="text/html" 로 변경시키면 된다.
	...
	public String Xml_Exam03() {
		...
		try {
			...
			urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=%2FrYgARvmB1eHpKFDWKJ7i8S%2FWiAvOIeSrcNER4hTxwJJNzA73hIwEGB2OoLe4MFbBhB7i6jNvWKkxIls5Qo%2B9w%3D%3D");	/* 자신의 서비스키 = Service Key*/
	...
	@RequestMapping(value = "/test07", produces = "text/xml; charset=utf-8")
	@ResponseBody
	public String Json_Exam07() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=%2FrYgARvmB1eHpKFDWKJ7i8S%2FWiAvOIeSrcNER4hTxwJJNzA73hIwEGB2OoLe4MFbBhB7i6jNvWKkxIls5Qo%2B9w%3D%3D"); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
	        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
